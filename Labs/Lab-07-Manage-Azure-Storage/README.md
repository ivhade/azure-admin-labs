...
## Evidence
 ...
 - ![](screenshots/Lifecycle-Management-Rule.png)
 - ![](screenshots/Container.png)
 - ![](screenshots/Container-and-Access-Policy.png)
 - ![](screenshots/Container-data.png)
 - ![](screenshots/Proof-Container-inPrivate.png)
 - ![](screenshots/SAS-setting.png)
 - ![](screenshots/Access-Container-Via-SAS.png)
 - ![](screenshots/File-Share.png)
 - ![](screenshots/File-Share-Data.png)
 - ![](screenshots/Virtual-Network.png)
 - ![](screenshots/Vnet-Service-EndPoints.png)
 - ![](screenshots/Public-Network-Access.png)